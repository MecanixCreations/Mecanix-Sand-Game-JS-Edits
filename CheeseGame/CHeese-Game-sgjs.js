    ...
    n.init = function(n, r) {
        ...
        const i = o("blue_cheese", "217,205,181\r\n201,195,165\r\n201,181,148\r\n62,102,141\r\n154,167,180", 62,102,141, d.SAND, "Blue Cheese",4,c.DEFAULT_SIZE),
            ...
            f = o("cheddar_cheese", "249,192,46\r\n249,176,46", 249,192,46, d.SOIL, "Grated Cheddar Cheese",8,c.DEFAULT_SIZE),
            ...
            TT = o("eat", "221,180,117", 255,186,119, d.AIR, "Eat",15,c.DEFAULT_SIZE),
   
            VV = l.roundBrushToolForSolidBody(s.colorRandomize(4, s.colorTexture(img$a, d.METAL)), c.DEFAULT_SIZE, c.METAL.getInfo().derive({
            ...
            j = {
                tools: [TT, c.MOVE, c.FLIP_VERTICALLY,u,i,h,f,g,F,U,J,G,p,H,I,VV,CC,EE,AA,FF,RR,c.WALL,c.ROCK_TEMPLATES,c.THERMITE,c.METAL,c.FIRE, c.METEOR /*c.SAND,c.ERASE_SLASH,c.FIRE_SLASH,c.HOT_SLASH,c.COLD_SLASH, c.WATER,  c.SOIL, c.GRAVEL, c.COAL,   c.ROCK_TEMPLATES, c.TEMPLATES, c.ROCK,c.TAR, c.WOOD,c.WOOD_1,c.LEAF,c.LEAF_1,c.GRASSPLACE, c.GLASS,c.METAL, c.STEEL, c.BRASS, c.GLASS_MOLTEN,c.METAL_MOLTEN,c.STEEL_MOLTEN, c.BRASS_MOLTEN,c.LAVA,*/ ],
